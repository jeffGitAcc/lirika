...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className="hover:bg-[#4c426e] w-full flex flex-row items-center py-2 p-4 rounded-lg cursor-pointer mb-2 ">
    <h3 className="text-white font-bold text-base mr-3">{i + 1}</h3>
    <div className="flex-1 flex flex-row justify-between items-center">
      <img className="w-15 h-14 rounded-lg" src={song?.images?.coverart} alt={song?.title} />
